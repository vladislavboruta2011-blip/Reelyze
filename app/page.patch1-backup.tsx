...
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-[1950px] min-w-[1440px] bg-[#050505]">
        <aside className="absolute left-0 top-0 h-[1950px] w-[230px] border border-[#24242A] bg-[#07080D]">
          <img
            src="/logo.png"
            alt="Reelyze logo"
        ...
        {/* ── HERO ── */}
        <div className="absolute left-[270px] top-[40px] h-[420px] w-[1140px]">
          <div className="absolute left-0 top-[10px] flex h-[32px] items-center gap-2 rounded-full border border-[#24242A] bg-[#0B0C10] px-[16px]">
            <span className="text-[13px] font-semibold leading-[24px] text-[#EF4444]">
              For YouTube Shorts scripts
            </span>
          </div>

          <h1 className="absolute left-0 top-[60px] w-[640px] text-[46px] font-semibold leading-[54px] text-white">
            Analyze your Shorts script{" "}
            <span className="text-[#EF4444]">before you upload.</span>
          </h1>

          <p className="absolute left-0 top-[210px] w-[600px] text-[16px] font-normal leading-[26px] text-[#B3B3B3]">
  ...
  className="absolute left-0 top-[300px] flex h-[56px] w-[210px] items-center justify-center rounded-[14px] border border-[#EF4444] bg-[#EF4444] text-[17px] font-semibold leading-[24px] text-white transition hover:bg-[#dc2626]"
>
  Start Analyzing
</a>

          <p className="absolute left-0 top-[372px] w-[600px] text-[13px] font-normal leading-[20px] text-[#777A85]">
            Currently optimized for YouTube Shorts scripts. More formats coming soon.
          </p>

          {/* Static preview card */}
          <div className="absolute left-[700px] top-[10px] h-[400px] w-[440px] rounded-[20px] border border-[#24242A] bg-[#0B0C10] px-[24px] py-[22px]">
            <p className="text-[15px] font-semibold leading-[24px] text-white">Script Review</p>
            <p className="mt-[4px] text-[12px] font-normal leading-[20px] text-[#B3B3B3]">Analyzed just now</p>

            <div className="mt-[16px] flex items-center gap-[10px]">
              <div className="flex h-[64px] w-[64px] items-center justify-center rounded-full border-[4px] border-[#22C55E]">
                <span className="text-[16px] font-semibold text-white">82</span>
              </div>
              <div>
                <p className="text-[12px] font-medium leading-[18px] text-white">Hook Score</p>
                <p className="text-[11px] font-normal leading-[16px] text-[#B3B3B3]">Strong</p>
              </div>

              <div className="ml-[16px] flex h-[64px] w-[64px] items-center justify-center rounded-full border-[4px] border-[#F59E0B]">
                <span className="text-[16px] font-semibold text-white">78</span>
              </div>
              <div>
                <p className="text-[12px] font-medium leading-[18px] text-white">Overall Score</p>
                <p className="text-[11px] font-normal leading-[16px] text-[#B3B3B3]">Medium risk</p>
              </div>
            </div>

            <div className="mt-[18px] rounded-[12px] border border-[#24242A] bg-[#0B1018]/[0.0784] px-[14px] py-[12px]">
              <p className="text-[12px] font-normal leading-[20px] text-[#B3B3B3]">
                What if I told you most Shorts lose viewers in the first 3 seconds?
              </p>
              <p className="mt-[8px] rounded-[8px] border border-[#EF4444]/30 bg-[#1A0608] px-[10px] py-[6px] text-[12px] font-normal leading-[20px] text-[#EF4444]">
                00:07 — The intro drags before the main point.
              </p>
            </div>

            <div className="mt-[14px] rounded-[12px] border border-[#24242A] bg-[#0B0C10] px-[14px] py-[12px]">
              <p className="text-[12px] font-semibold leading-[18px] text-white">
  Suggested Fix
</p>
<p className="mt-[6px] text-[12px] font-normal leading-[18px] text-[#B3B3B3]">
  Cut the slow intro and start with the main value before viewers scroll.
</p>
            </div>
          </div>
        </div>
        ...
        <section
          id="analyzer"
          className="absolute left-[270px] top-[717px] h-[700px] w-[720px] rounded-[20px] border border-[#24242A] bg-[#0B0C10]"
        >
        ...
        <button
          ...
          className="absolute left-[295px] top-[1292px] h-[56px] w-[230px] rounded-[14px] border border-[#24242A] bg-[#EF4444] text-[17px] font-semibold leading-[24px] text-white transition hover:bg-[#dc2626] disabled:cursor-not-allowed disabled:opacity-80"
        >
          {isAnalyzing ? "Analyzing..." : "Analyze Script"}
        </button>

        {analyzeError && (
          <p className="absolute left-[295px] top-[1358px] text-[13px] font-normal leading-[20px] text-[#EF4444]">
            {analyzeError}
          </p>
        )}

        <div className="absolute left-[570px] top-[1307px] flex h-[24px] w-[312px] items-center gap-2 text-[14px] font-normal leading-[24px] text-[#B3B3B3]">
          <Lock size={14} />
          <span>Your data is secure and will not be shared</span>
        </div>

        <section className="absolute left-[1010px] top-[717px] h-[530px] w-[400px] rounded-[20px] border border-[#24242A] bg-[#0B0C10]">
          ...
          <FeatureItem
            ...
            icon={<Gauge size={42} />}
            title="Overall Score"
            description="See how strong your script is before posting."
          />
          ...
          <FeatureItem
            ...
            icon={<Target size={42} />}
            title="Hook Analysis"
            description="Find out if your opening stops the scroll."
          />
          ...
          <FeatureItem
            ...
            description="Spot moments where viewers may lose interest."
          />
          ...
          <FeatureItem
            ...
            title="Risky Parts"
            description="Get specific lines and timestamps to improve."
          />
          ...
          <FeatureItem
            ...
            description="Receive clear fixes for hooks, pacing, and payoff."
          />
        </section>
