...
export function MainTakeaway({ takeaway }: { takeaway: TakeawayCopy }) {
  return (
    <section className="rounded-[28px] border border-[#7C3AED]/30 bg-gradient-to-br from-[#7C3AED]/[0.12] via-[#7C3AED]/[0.04] to-transparent p-6 lg:p-10">
      <div className="flex flex-col items-start gap-5 sm:flex-row sm:items-center">
        <div
          className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full border border-[#7C3AED]/40 bg-[#7C3AED]/15 text-[#C4B5FD] shadow-[0_0_36px_rgba(124,58,237,0.25)]"
          aria-hidden="true"
        >
          <Sparkles size={26} />
        </div>
